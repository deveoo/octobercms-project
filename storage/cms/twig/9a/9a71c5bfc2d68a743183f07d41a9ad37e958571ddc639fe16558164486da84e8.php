...
/* C:\xampp\htdocs\nasp/themes/nasp/pages/single-fournisseur.htm */
class __TwigTemplate_c39e44c9d1c181cdddd26d6eea78d2a296b879dec75a339450217ae1e20ba0ac extends Twig_Template
{
    private $source;
  ...
  <div class=\"container\">
    <div class=\"row\">
        ...
        echo "\">
          ";
        // line 7
        echo twig_get_attribute($this->env, $this->source, ($context["supplier"] ?? null), "description2", array());
        echo "
        </div>
        <div class=\"col-md-6\">
          ";
        // line 10
        echo twig_get_attribute($this->env, $this->source, ($context["supplier"] ?? null), "description1", array());
        echo "
        </div>
    </div>
  </div>
...
<!-- ******************************************************************* -->";
  ...
  <div class=\"container\">
    <div class=\"row\">
        <div class=\"col-md-6\">
          <h1>{{supplier.titre}}</h1>
          <img src=\"{{supplier.image.path}}\" alt=\"{{supplier.titre}}\">
          {{supplier.description2|raw }}
        </div>
        <div class=\"col-md-6\">
          {{supplier.description1|raw }}
        </div>
    </div>
  </div>
</section>
...
<div class=\"Disponible\">
    <div class=\"container\">
      <div class=\"row\">
        <div class=\"col-xs-12\">
          <div class=\"TitleDispo\">{{'Produits'|_}}</div>
          <div class=\"AllDispo\">
            <div id=\"owl-disponile\">
              {% for i in 0..10 %}
              <div class=\"item\">
